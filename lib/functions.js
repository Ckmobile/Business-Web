	...
	return new Promise(async (resolve, reject) => {
	   try {
		  if (/^https?:\/\//i.test(string)) {
			 ...
			 resolve({ data, size, sizeH: formatSize(size), ...((await fileType.fromBuffer(data)) || { mime: "application/octet-stream", ext: ".bin" }) });
			 ...
			 resolve({ data: string, size, sizeH: formatSize(size), ...((await fileType.fromBuffer(string)) || { mime: "application/octet-stream", ext: ".bin" }) });
			 ...
			 resolve({ data: buffer, size, sizeH: formatSize(size), ...((await fileType.fromBuffer(buffer)) || { mime: "application/octet-stream", ext: ".bin" }) });
		  }
	   } catch (e) {
...
export { getBuffer, getGroupAdmins, getRandom, h2k, isUrl, Json, runtime, sleep , fetchJson, getsize, formatBytes, fetchBuffer, formatSize, getFile };
